...
?>
	<div class="main-content-agile">
		<div class="sub-main-w3">
			...
			<form action="companydetails.php" method="post" name="form" onsubmit="return(calculate())">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h2 style="color:#093fed;">Go to</h2>&nbsp;<a href="" >Home Page</a>&nbsp;<span class="fa fa-home" aria-hidden="true"></span> <br><br><br>
