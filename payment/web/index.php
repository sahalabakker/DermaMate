...
$sel="select max(address_id) from address where user_name='$email'";
$res=$ob->db_read($sel);
...
$update="update address SET status='1' where address_id='$id'";
$ob->db_read($update);?>
<script>
	window.location='../../web/web/animation.php'
	</script>;<?php
}
if(isset($_POST['sub1']))
{
