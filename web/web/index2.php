...
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="index2.php"><img src="images/appointment.png"/><h1>Appointment <span>CORNER</span></h1></a>
		</div>
...
<div class="banner-agile">
	<div class="container">
		<h2>WELCOME TO</h2>
		<h3>APPOINTMENT <span>CORNER</span></h3>
		...
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Specialists</span></li>
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						$sel1="select * from registration where user_name In(select user_name from login where user_type=2)";
					...
					
					{
						...
						$id=$row[1];
						$sel2="select * from dermatologist where user_name='$id'";
						 
						$res2=$ob->db_read($sel2);
					$row1=mysqli_fetch_array($res2);
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href='single1.php?id1={$row[1]}'><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
								echo("<img height=500px width=130px src=../../uploads/$row1[12] alt=mikku />");echo("</a>");
