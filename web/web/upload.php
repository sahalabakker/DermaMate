...
$emaildoctor=$_SESSION['user_name'];
if(isset($_POST['up']))
{
	$pemail=$_POST['pemail'];
	$demail=$_POST['demail'];
	...
	$insert="insert into patient(d_username,p_username,symptoms,medicine,today_date,next_date) values('$demail','$pemail','$symptoms','$medicines','$tdate','$ndate')";
$res=$ob->db_write($insert);
?>
							<script>

							alert("Consultation history uploaded successfully");
