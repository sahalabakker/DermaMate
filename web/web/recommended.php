		...
		<div class="col-md-7 navigation-agileits">
			<nav class="navbar navbar-default">
				<div class="navbar-header nav_2">
					<button type="button" class="navbar-toggle collapsed navbar-toggle1" data-toggle="collapse" data-target
				</div> 
...
$email=$_SESSION['user_name'];
						$sel1="select * from address where user_name='$email'";
					...
					
					{
						...
						$id=$row[0];
						$sel2="select * from product where product_id IN(select product_id from address where address_id='$id')";
...
$total=$price-$tot1;
		  ...
		  <tr class="cross">
			...
			<td class="t-data">Rs.<?php echo $row[6];?></td>


			<td class="t-data">							<form action="review.php?id=<?php echo $row1[0];?>" method="post">
