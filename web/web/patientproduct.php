...
<div class="banner-agile">
	<div class="container">
		...
		<p>Cure your derma problems by purchasing the best derma products ...</p>
			...
			<div id="horizontalTab">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						$sel1="select * from product where status='1' and product_type='0'";
						...
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href='patientproduct1.php?id1={$row[0]}'><div class=product-img>");
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						$sel8="select * from product where status='1' and product_type='1'";
						...
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href='patientproduct1.php?id1={$row8[0]}'><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
