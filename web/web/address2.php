...
$insert="insert into address(user_name,product_id,quantity,total_cost,full_name,house_name,city,district,state,country,contact_number,pincode)
values('$email','$productid','$quantity','$cost','$fullname','$housename','$city1','$district1','$state1','$country1','$contact1','$pin')";
$res1=$ob->db_write($insert);

?><script>
	alert("Address details upload successfully.You have to pay Rs.<?php echo $cost?>");
...
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="index.html"><img src="images/appointment.png" alt=" " /><h1>CHECKOUT<span>ZONE</span></h1></a>
		</div>
...
<tr ><td bgcolor="white">
						...
						<b>Contact Number</b></td><td bgcolor="white" colspan="8">
							...
							<input class="form-control" type="text"  name="contact"  required=""  pattern="[+0-9]{13}" onfocus="(this.value='+91')">
							<div class="clearfix"></div>
						</td></tr><tr><td bgcolor="white">
						...
						<p align="center">
						<button type="submit" name="sub" class="btn btn-danger">Deliver to this address</button></a>
				</div>
