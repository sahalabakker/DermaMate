...
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="index2.php"><img src="images/appointment.png"/><h1>PRODUCT  <span>GALLERY</span></h1></a>
		</div>
	...
	<div class="container">
									...
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Women's Clothing</a></li>
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Jewellery </a></li>
												<li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Watches</a></li>
												<li><a href="cosmetics.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Cosmetics</a></li>
												<li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Deo & Perfumes</a></li>
										...
										<div class="col-sm-4">
											...
											<ul class="multi-column-dropdown">
												...
												<li><a href=""><i class="fa fa-angle-right" aria-hidden="true"></i>Handbags</a></li>
		...
		<div class="col-md-4 search-agileinfo">
			<form action="#" method="post">
				<input type="search" name="Search" placeholder="Search for a Doctor..." required="">
		...
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					...
					<li class="resp-tab-item"><span>Surgeons</span></li>	
				...
				<div class="resp-tabs-container">
					...
					$row1=mysqli_fetch_array($res2); 
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href='cartproduct1.php?id1={$row[0]}'><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
								echo("<img height=500px width=130px src=../../uploads/$row1[8] alt=mikku />");echo("</a>");
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href=single.html><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
								echo("<img src=images/hair.jpg alt=mikku />");
								echo("<div class=p-mask>");
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href=single.html><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
								echo("<img src=images/doctor.jpg alt=mikku />");
								echo("<div class=p-mask>");
