...
<div class="top-products">
	<div class="container">
		<h3>Derma Products</h3>
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item"><span>Skin Care</span></li>
					<li class="resp-tab-item"><span>Hair Care</span></li>
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						$sel1="select * from product where owner_email='$email' and product_type='0'";
						...
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href='product1.php?id1={$row[0]}'><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
								echo("<img src=../../uploads/$row[8] alt=mikku />");echo("</a>");
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content">
						...
						$sel8="select * from product where owner_email='$email' and product_type='1'";
						...
						echo("<div class=col-md-4 top-product-grids tp1 animated wow slideInUp data-wow-delay=.5s>");
							echo("<a href='product1.php?id1={$row8[0]}'><div class=product-img>");
							echo("<span class=notify-badge>NEW</span>");
								echo("<img src=../../uploads/$row8[8] alt=mikku />");echo("</a>");
								echo("<div class=p-mask>");
