			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					...
					<div class="col-md-6 single-top-right">
						...
						<form action="productupdate.php?id=<?php echo $id;?>" method="post">
							
					<button type="submit" class="w3ls-cart" ><i class="fa fa-update" aria-hidden="true"></i>Edit</button></a>
						</form>
					<form action="#" method="POST">
					<button type="submit" name="del"  class="w3ls-cart w3ls-cart-like"><i class="fa fa-trash" aria-hidden="true"></i>Delete</button></form>
					</div>
				   <div class="clearfix"> </div>  
				</div>
			</div> 
